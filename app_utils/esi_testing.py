...
try:
    ...
    class BravadoOperationStub:
        ...
        def __init__(
            ...
            self._reason = reason
            self.request_config = BravadoOperationStub.RequestConfig(
    ...
    class EsiEndpoint:
        ...
        def requires_testdata(self) -> bool:
            ...
            """
            return (
                self.data is None and not self.http_error_code and not self.side_effect
            )
        ...
        def __init__(
            ...
            if endpoint.data is not None:
                ...
                try:
                    ...
                    text = f"{self._endpoint.category}.{self._endpoint.method}: No test data"
    ...
    class EsiClientStub:
        ...
        def replace_endpoints(
            self, new_endpoints: List[EsiEndpoint]
        ) -> "EsiClientStub":
